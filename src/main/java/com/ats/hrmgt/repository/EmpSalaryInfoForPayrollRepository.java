...
public interface EmpSalaryInfoForPayrollRepository extends JpaRepository<EmpSalaryInfoForPayroll, Integer> {
	...
	@Query(value = "select\n" + 
			"        data.*,\n" + 
			"        CASE     \n" + 
			"            WHEN a.sal_count>0 THEN ifnull(b.sal_count,\n" + 
			"            0)     \n" + 
			"            ELSE 1 \n" + 
	...
	List<EmpSalaryInfoForPayroll> getEmployeeListWithEmpSalEnfoForArrear(List<Integer> locId);
	...
	@Query(value = "select a.*,ifnull(b.count_leave,0) as count_leave, 0 as can_generate_sal,0 as gender  from ( select \n" + 
			...
			"        e.emp_id=si.emp_id          \n" + 
			"        and e.del_status=1          \n" + 
			"        and et.emp_type_id=e.emp_type and e.emp_type=:typeId         \n" + 
			"        and l.loc_id = e.location_id          \n" + 
			"        and st.sal_type_id=si.salary_type_id          \n" + 
			"        and de.desig_id=e.designation_id          \n" + 
			"        and dp.depart_id=e.depart_id          \n" + 
	...
	@Query(value = "select a.*,ifnull(b.count_leave,0) as count_leave, 0 as can_generate_sal,0 as gender  from ( select \n" + 
			...
			"        and st.sal_type_id=si.salary_type_id          \n" + 
			"        and de.desig_id=e.designation_id          \n" + 
			"        and dp.depart_id=e.depart_id  and e.depart_id=:deptId        \n" + 
			"        and sd.emp_id=e.emp_id         \n" + 
			"        and sd.month=:month \n" + 
			"        and sd.year=:year         \n" + 
			"        and e.emp_id not in (\n" + 
	...
	@Query(value = "select a.*,ifnull(b.count_leave,0) as count_leave, 0 as can_generate_sal,0 as gender  from ( select \n" + 
			...
			"        and st.sal_type_id=si.salary_type_id          \n" + 
			"        and de.desig_id=e.designation_id          \n" + 
			"        and dp.depart_id=e.depart_id  and e.depart_id=:deptId and e.emp_type=:typeId\n" + 
			"        and sd.emp_id=e.emp_id         \n" + 
			"        and sd.month=:month \n" + 
			"        and sd.year=:year         \n" + 
			"        and e.emp_id not in (\n" + 
	...
	List<EmpSalaryInfoForPayroll> getListForfixunfixAttendance(int month, int year, int isFixed, String sts,
			List<Integer> locId, int typeId, int deptId);
	...
	@Query(value = "select\n" + 
			...
			"            and st.sal_type_id=si.salary_type_id                   \n" + 
			"            and de.desig_id=e.designation_id                   \n" + 
			"            and dp.depart_id=e.depart_id and e.emp_type=:typeId                 \n" + 
			"            and sd.emp_id=e.emp_id                  \n" + 
			"            and sd.month=:month         \n" + 
			"            and sd.year=:year                 \n" + 
			"            and e.emp_id not in (\n" + 
