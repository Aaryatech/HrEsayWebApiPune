...
public interface EmpWithShiftDetailRepository extends JpaRepository<EmpWithShiftDetail, Integer> {
	...
	List<EmpWithShiftDetail> updateAssignShiftByDate(@Param("previousDate") String previousDate,@Param("fromDate") String fromDate, @Param("toDate")String toDate, int locId);
