...
public interface GetEmployeeDetailsRepo extends JpaRepository<GetEmployeeDetails, Integer>{
 ...
 GetEmployeeDetails  getEmpDetailList(@Param("empId") int empId);
	...
	@Query(value = "SELECT\n" + 
			...
			"        ) and emp.location_id in (:locId)", nativeQuery = true)

 List<GetEmployeeDetails>  getEmpDetailListByBonusId(@Param("bonusId") int bonusId, @Param("locId") List<Integer> locId);
 ...
 List<GetEmployeeDetails>  getEmpDetailListByBonusIdAssignedBonus(@Param("bonusId") int bonusId, List<Integer> locId);
	...
	//getAllEmployeeDetailassignSubCompany
	...
	@Query(value = "SELECT\n" + 
			...
			"            OR salinfo.cmp_leaving_date = 1970 -00 -00 \n" + 
			"            OR DATE_FORMAT(             salinfo.cmp_leaving_date,             '%Y-%m'         ) >= DATE_FORMAT(CURDATE(), '%Y-%m'))"
			+ "ORDER BY emp.ex_int2 ", nativeQuery = true)
	...
	@Query(value = " SELECT\n" + 
			...
			"            OR salinfo.cmp_leaving_date = 1970 -00 -00              \n" + 
			"            OR DATE_FORMAT(             salinfo.cmp_leaving_date,             '%Y-%m'         ) >= DATE_FORMAT(CURDATE(), '%Y-%m')\n" + 
			"        ) ORDER BY emp.emp_category ", nativeQuery = true) 
	...
	@Query(value = "SELECT\n" + 
			...
			"            OR salinfo.cmp_leaving_date = 1970 -00 -00 \n" + 
			"            OR DATE_FORMAT(             salinfo.cmp_leaving_date,             '%Y-%m'         ) >= DATE_FORMAT(CURDATE(), '%Y-%m')\n" + 
			"        ) ORDER BY emp.next_shiftid ", nativeQuery = true)
...
"    e_info.emp_id = emp.emp_id \n" + 
	...
	List<GetEmployeeDetails> getAllEmployeeDetailassignSubCompany();
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) ORDER BY emp.emp_type  ", nativeQuery = true)

	List<GetEmployeeDetails> getAllEmployeeDetailshowAssignEmpType();
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) ORDER BY emp.designation_id  ", nativeQuery = true)


	List<GetEmployeeDetails> getAllEmployeeDetailshowAssignDesignation();
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) ORDER BY emp.current_shiftid  ", nativeQuery = true)

	List<GetEmployeeDetails> getAllEmployeeDetailshowEmpListToAssignShift();
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) ORDER BY emp.depart_id  ", nativeQuery = true)


	List<GetEmployeeDetails> getAllEmployeeDetailassignDept();
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) ORDER BY emp.location_id  ", nativeQuery = true)


	List<GetEmployeeDetails> getAllEmployeeDetailshowAssignLocation();
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) ORDER BY emp.holiday_category  ", nativeQuery = true)


	List<GetEmployeeDetails> getAllEmployeeDetailassignHolidayCategory();
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) ORDER BY emp.weekend_category  ", nativeQuery = true)


	List<GetEmployeeDetails> getAllEmployeeDetailassignWeekoffCategory();
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) ORDER BY salinfo.salary_type_id  ", nativeQuery = true)



	List<GetEmployeeDetails> getAllEmployeeDetailshowEmpListToAssignSalStruct();
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m'))  and emp.emp_id not in (\n" + 
			"            select\n" + 
			"                emp_id              \n" + 
			"            from\n" + 
			"                leave_balance_cal              \n" + 
	...
	List<GetEmployeeDetails> getEmpDetailListForCarryForwardLeave(@Param("locId") int locId);
	...
	@Query(value = "SELECT\n" + 
			...
			+ " and emp.emp_id not in (SELECT tbl_loan_main.emp_id FROM tbl_loan_main WHERE tbl_loan_main.current_outstanding!=0) " + 
			"                and emp.emp_id not in (SELECT tbl_loan_main.ex_int1 FROM tbl_loan_main WHERE tbl_loan_main.current_outstanding!=0) " + 
	...
	@Query(value = "SELECT\n" + 
			...
			"        au.emp_id = emp.emp_id          \n" + 
			"        AND(\n" + 
			"            au.ca_ini_auth_emp_id =:empId              \n" + 
			"            OR au.ca_fin_auth_emp_id =:empId            \n" + 
			"            OR emp.emp_id =:empId              \n" + 
			"        )          \n" + 
			"        AND      emp.del_status = 1           \n" + 
			"        AND(\n" + 
			...
			"            OR DATE_FORMAT(             salinfo.cmp_leaving_date,             '%Y-%m'         ) >= DATE_FORMAT(CURDATE(), '%Y-%m')         \n" + 
			"        )", nativeQuery = true)
	List<GetEmployeeDetails> getEmpListForClaimAuthByEmpId(@Param("empId") int empId);
	...
	@Query(value = "SELECT\n" + 
			...
			"    holidaycat.ho_cat_id = emp.holiday_category\n" + 
			"WHERE\n" + 
			"    emp.del_status = 1 and emp.location_id=:locId AND(\n" + 
			"        salinfo.cmp_leaving_date IS NULL OR salinfo.cmp_leaving_date = '' OR salinfo.cmp_leaving_date = 1970 -00 -00 OR DATE_FORMAT(\n" + 
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m'))  ", nativeQuery = true)
	...
	List<GetEmployeeDetails> getAllEmployeeDetailBylocationId(@Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId) ORDER BY emp.sub_cmp_id", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailassignSubCompanyLocId(@Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId) ORDER BY emp.emp_type  ", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailshowAssignEmpTypeLocId(@Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId) ORDER BY emp.designation_id  ", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailshowAssignDesignationLocId(@Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId) ORDER BY emp.depart_id  ", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailassignDeptlocId(@Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            OR salinfo.cmp_leaving_date = '' \n" + 
			"            OR salinfo.cmp_leaving_date = 1970 -00 -00 \n" + 
			"            OR DATE_FORMAT(             salinfo.cmp_leaving_date,             '%Y-%m'         ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId)"
			+ "ORDER BY emp.ex_int2 ", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailSkillRateLocId(@Param("locId") List<Integer> locId);
	...
	@Query(value = " SELECT\n" + 
			...
			"            OR salinfo.cmp_leaving_date = 1970 -00 -00              \n" + 
			"            OR DATE_FORMAT(             salinfo.cmp_leaving_date,             '%Y-%m'         ) >= DATE_FORMAT(CURDATE(), '%Y-%m')\n" + 
			"        ) and emp.location_id in (:locId) ORDER BY emp.emp_category ", nativeQuery = true) 
	List<GetEmployeeDetails> getAllEmployeeDetailAccesssRoleLocId(@Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId) ORDER BY emp.holiday_category  ", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailassignHolidayCategoryLocId(@Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId) ORDER BY emp.weekend_category  ", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailassignWeekoffCategoryLocId(@Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId) ORDER BY salinfo.salary_type_id  ", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailshowEmpListToAssignSalStructLocId(@Param("locId") List<Integer> locId);
...
"    e_info.emp_id = emp.emp_id \n" + 
			...
			"            salinfo.cmp_leaving_date,\n" + 
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId) ORDER BY usr.ex_var1 ", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailForLoginTypeLocId(@Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            '%Y-%m'\n" + 
			"        ) >= DATE_FORMAT(CURDATE(), '%Y-%m')) and emp.location_id in (:locId)", nativeQuery = true)
	List<GetEmployeeDetails> getEmpInfoListForLeaveAuthLocId( @Param("locId") List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"    WHERE\n" + 
			"        emp.del_status = 1 \n" + 
			"        and emp.emp_id not in ( select f.emp_id from t_fulnfinal f) and emp.location_id in (:locId)", nativeQuery = true)
	List<GetEmployeeDetails> getAllEmployeeDetailForFullnFinalLocId(List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            ON     holidaycat.ho_cat_id = emp.holiday_category \n" + 
			"    WHERE\n" + 
			"        emp.location_id IN (:locId) and (\n" + 
			"            salinfo.cmp_leaving_date is not NULL \n" + 
			"            OR salinfo.cmp_leaving_date != ''  \n" + 
			"        )  \n" + 
			"         ", nativeQuery = true) 
	List<GetEmployeeDetails> getLeftEmployeeDetailBylocationId(List<Integer> locId);
	...
	@Query(value = "SELECT\n" + 
			...
			"            ON     holidaycat.ho_cat_id = emp.holiday_category\n" + 
			"    LEFT JOIN\n" + 
			"        tbl_emp_info emp_info                           \n" + 
			"            ON     emp_info.emp_id = emp.emp_id\n" + 
			"    LEFT JOIN\n" + 
			"        m_grade gd                           \n" + 
			"            ON     gd.grade_id = emp_info.ex_int1           \n" + 
			"    WHERE\n" + 
			"        emp.del_status = 1                   \n" + 
			"        AND(\n" + 
			"            salinfo.cmp_leaving_date IS NULL                           \n" + 
			...
			"    ORDER BY\n" + 
			"        emp_info.ex_int1", nativeQuery = true) 
	List<GetEmployeeDetails> getAllEmployeeDetailGradeLocId(List<Integer> locId);
}
