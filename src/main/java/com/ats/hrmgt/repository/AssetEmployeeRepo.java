...
public interface AssetEmployeeRepo extends JpaRepository<AssetEmployee, Integer> {
	...
	List<AssetEmployee> getAllAssetsEmpByLocation(@Param("locId") int locId);
	...
	AssetEmployee getAssetsEmpByLocationAndEmpId(@Param("locId") int locId, @Param("empId") int empId);
}
