...
public interface PayDeductionDetailsRepo extends JpaRepository<PayDeductionDetails, Integer> {
	...
	List<PayDeductionDetails> getEmpPayDed(@Param("fromYear") String fromYear,@Param("fromMonth") String fromMonth,@Param("toYear") String toYear,@Param("toMonth") String toMonth,@Param("empId") int empId);
