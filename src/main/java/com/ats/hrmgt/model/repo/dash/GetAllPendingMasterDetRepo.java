...
public interface GetAllPendingMasterDetRepo  extends JpaRepository<GetAllPendingMasterDet,String>{
	...
	@Query(value = "SELECT\n" + 
			...
			"        tbl_mst_sub_company\n" + 
			"    WHERE\n" + 
			"        tbl_mst_sub_company.del_status = 1\n" + 
			") AS company_count,\n" + 
			"(\n" + 
			"    SELECT\n" + 
			"        COUNT('')\n" + 
			...
			"        tbl_mst_emp_types\n" + 
			"    WHERE\n" + 
			"        tbl_mst_emp_types.del_status = 1\n" + 
			") AS emptype_count,\n" + 
			"(\n" + 
			"    SELECT\n" + 
			"        COUNT('')\n" + 
			...
			"    WHERE\n" + 
			"        leave_structure_header.del_status = 1\n" + 
			") AS lvstruct_count,\n" + 
			"(\n" + 
			"    SELECT\n" + 
			"        COUNT('')\n" + 
			...
			"    WHERE\n" + 
			"        m_employees.emp_id NOT IN( SELECT \n" + 
			"            leave_structure_allotment.emp_id FROM leave_structure_allotment WHERE  leave_structure_allotment.del_status = 1)\n" + 
			...
			"        WHERE\n" + 
			"            m_employees.emp_id NOT IN( SELECT\n" + 
			"                leave_authority.emp_id  FROM  leave_authority WHERE   leave_authority.del_status = 1)\n" + 
