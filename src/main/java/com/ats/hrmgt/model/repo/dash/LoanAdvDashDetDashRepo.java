...
public interface LoanAdvDashDetDashRepo extends JpaRepository<LoanAdvDashDet, String> {
	...
	LoanAdvDashDet getAdvnceDetails(@Param("year") String  year,@Param("month") String  month,@Param("locId") int locId);
	...
	LoanAdvDashDet getLoanDetails(@Param("currDate") String  currDate,@Param("locId") int locId);
