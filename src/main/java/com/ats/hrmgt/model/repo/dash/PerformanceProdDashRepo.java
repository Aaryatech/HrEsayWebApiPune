...
public interface PerformanceProdDashRepo extends JpaRepository<PerformanceProdDash,String> {
	...
	PerformanceProdDash getPerformanceDetails(@Param("year") String  year,@Param("month") String  month,@Param("empId") int  empId);
	...
	@Query(value = "\n" + 
			...
			"", nativeQuery = true)
	PerformanceProdDash getProdDetails(@Param("year") String  year,@Param("month") String  month,@Param("empId") int  empId);
}
