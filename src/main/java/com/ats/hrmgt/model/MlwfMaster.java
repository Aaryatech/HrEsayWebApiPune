...
public class MlwfMaster {
	...
	public String toString() {
		return "MlwfMaster [id=" + id + ", locationId=" + locationId + ", month=" + month + ", employerValue="
				+ employerValue + ", employeeValue=" + employeeValue + ", extraInt1=" + extraInt1 + ", extraInt2="
				+ extraInt2 + ", extraVar1=" + extraVar1 + ", extraVar2=" + extraVar2 + "]";
	}
