...
public class InoutTable {
	...
	public String toString() {
		return "InoutTable [id=" + id + ", EmpCode=" + EmpCode + ", PunchDateTime=" + PunchDateTime + ", LogDate="
				+ LogDate + ", LogTime=" + LogTime + ", Direction=" + Direction + ", WorkCode=" + WorkCode
				+ ", DeviceName=" + DeviceName + ", SerialNo=" + SerialNo + ", VerMode=" + VerMode + "]";
	}
